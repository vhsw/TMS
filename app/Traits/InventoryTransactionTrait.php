...
trait InventoryTransactionTrait
{
    ...
    /**
     * Returns true or false depending if the
     * current state of the transaction is a request.
     *
     * @return bool
     */
    public function isRequest()
    {
        return ($this->state === $this::STATE_REQUESTED_PENDING ? true : false);
    }
    ...
    /**
     * Creates a transaction that specifies the amount of quantity that has been requested.
     * The ordered or cancel method must be used after this is performed.
     *
     * @param int|float|string $quantity
     *
     * @throws InvalidQuantityException
    ...
    public function requested($quantity)
    {
        ...
        return $this->processSave('inventory.transaction.requested');
    }
     ...
     * back ordered, request-pending, ordered-pending, and inventory on hold CAN be cancelled
     *
